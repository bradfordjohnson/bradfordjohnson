...
[My Own R "Cookbook"](https://bradfordjohnson.github.io/r-cookbook/)| This is a Quarto book made in R. Its purpose is to show different ways of approaching analytics concepts and showing useful code for R beginners | ![WIP](https://img.shields.io/badge/%E2%8F%B3-Work%20in%20progress-red)
[Twitter Analysis Project](https://github.com/bradfordjohnson/twitter-analysis-project) | This is a project using R to scrape Tweets using the twitter API, and cleaning it with R before storing this data in my own database. After collecting data I will then connect to my database via R, to then query it using SQL and finally visualizing insights with R. | ![WIP](https://img.shields.io/badge/%E2%8F%B3-Work%20in%20progress-red)
